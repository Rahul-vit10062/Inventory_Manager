...
import 'package:Stock_Manager/app/transactions/salesOverview.dart';
import 'package:Stock_Manager/models/transaction.dart';
import 'package:Stock_Manager/models/user.dart';
import 'package:Stock_Manager/utils/scaffold.dart';
...
class TransactionListState extends State<TransactionList> {
  ...
  void _showTransactionProfit() async {
    ...
    List<int> items = new List.empty();
    List<double> costPrices = new List.empty();
    List<double> sellingPrices = new List.empty();
    List<double> profits = new List.empty();
    List<double> dueAmounts = new List.empty();
    List<String> dates = new List.empty();
